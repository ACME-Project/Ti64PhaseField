...
void thermo_auxillary_terms(MMSP::vector<store_type> gradient, MMSP::vector<store_type> gradientsq, double c_Al, double c_V)
{
	...
	dGBeta_dV = (G_V_beta/G_normalize - G_Ti_beta/G_normalize) + log(c_V) - log((1-c_Al-c_V)) + c_Al*L0_BCC_Al_V/G_normalize +
							...
							c_Al*c_V)*L0_BCC_Al_Ti_V/G_normalize ;
	del_dGAlpha_dAl = gradient[0][20]*(1.0/c_Al + 1.0/(1.0-c_Al-c_V) - 2*L0_HCP_Al_Ti/G_normalize) + gradient[0][21]*(1.0/(1.0-c_Al-c_V) +
							L0_HCP_Al_V/G_normalize - L0_HCP_Al_Ti/G_normalize -L0_HCP_Ti_V/G_normalize) ;
	del_dGBeta_dAl = gradient[0][20]*(1.0/c_Al + 1/(1-c_Al-c_V) - 2*L0_BCC_Al_Ti/G_normalize - 2*c_V*L0_BCC_Al_Ti_V/G_normalize) + 
								gradient[0][21]*(1/(1-c_Al-c_V) + L0_HCP_Al_V/G_normalize - L0_HCP_Al_Ti/G_normalize -L0_HCP_Ti_V/G_normalize +
								(1-2*c_Al-2*c_V)*L0_BCC_Al_Ti_V/G_normalize) ;	
	del_dGAlpha_dV = gradient[0][21]*(1.0/c_V + 1/(1-c_Al-c_V) - 2*L0_HCP_Ti_V/G_normalize) + gradient[0][20]*(1/(1-c_Al-c_V) + 
						    L0_HCP_Al_V/G_normalize - L0_HCP_Al_Ti/G_normalize - L0_HCP_Ti_V/G_normalize) ;	
	del_dGBeta_dV = 	gradient[0][21]*(1.0/c_V + 1/(1-c_Al-c_V) -2*L0_BCC_Ti_V/G_normalize - 2*c_Al*L0_BCC_Al_Ti_V/G_normalize) + 
							    gradient[0][20]*(1/(1-c_Al-c_V) + L0_BCC_Al_V/G_normalize - L0_BCC_Al_Ti/G_normalize - L0_BCC_Ti_V/G_normalize + 
							    (1-2*c_Al-2*c_V)*L0_BCC_Al_Ti_V/G_normalize) ;										    
	delsq_dGAlpha_dAl = gradientsq[0][20]*(1.0/c_Al + 1/(1-c_Al-c_V) - 2*L0_HCP_Al_Ti/G_normalize) + gradientsq[0][21]*(1/(1-c_Al-c_V) +
								L0_HCP_Al_V/G_normalize - L0_HCP_Al_Ti/G_normalize -L0_HCP_Ti_V/G_normalize) + gradient[0][20]*(-gradient[0][20]/pow(c_Al,2) +
								(gradient[0][20] + gradient[0][21])/pow((1-c_Al-c_V),2)) + gradient[0][21]*((gradient[0][20] + gradient[0][21])/pow((1-c_Al-c_V),2)) ;
					
	delsq_dGAlpha_dV = gradientsq[0][21]*(1.0/c_V + 1/(1-c_Al-c_V) - 2*L0_HCP_Ti_V/G_normalize) + gradientsq[0][20]*(1/(1-c_Al-c_V) +
									L0_HCP_Al_V/G_normalize - L0_HCP_Al_Ti/G_normalize - L0_HCP_Ti_V/G_normalize) + gradient[0][21]*(-gradient[0][21]/pow(c_V,2) +
									(gradient[0][20] + gradient[0][21])/pow((1-c_Al-c_V),2)) + gradient[0][20]*((gradient[0][20] + gradient[0][21])/pow((1-c_Al-c_V),2)) ;
									
		//cout<<n<<" "<<gradient[0][20]<<" "<<c_Al<<" "<<c_V<<" "<<L0_HCP_Al_Ti<<" "<<gradient[0][21]<<" "<<L0_HCP_Al_V<<" "<<L0_HCP_Ti_V<<" "<<del_dGAlpha_dAl<<endl;						
							
	delsq_dGBeta_dAl = gradientsq[0][20]*(1.0/c_Al + 1/(1-c_Al-c_V) - 2*L0_BCC_Al_Ti/G_normalize - 2*c_V*L0_BCC_Al_Ti_V/G_normalize) +
								  gradientsq[0][21]*(1/(1-c_Al-c_V) + L0_HCP_Al_V/G_normalize - L0_HCP_Al_Ti/G_normalize -L0_HCP_Ti_V/G_normalize +
								   (1-2*c_Al-2*c_V)*L0_BCC_Al_Ti_V/G_normalize) + gradient[0][20]*(-gradient[0][20]/pow(c_Al,2) + (gradient[0][20] +
								    gradient[0][21])/pow((1-c_Al-c_V),2) - 2*gradient[0][21]*L0_BCC_Al_Ti_V/G_normalize) + gradient[0][21]*((gradient[0][20] +
								     gradient[0][21])/pow((1-c_Al-c_V),2) + (-2*gradient[0][20]*gradient[0][21])*L0_BCC_Al_Ti_V/G_normalize) ;							
	delsq_dGBeta_dV = gradientsq[0][21]*(1.0/c_V + 1/(1-c_Al-c_V) -2*L0_BCC_Ti_V/G_normalize - 2*c_Al*L0_BCC_Al_Ti_V/G_normalize) +
								 gradientsq[0][20]*(1/(1-c_Al-c_V) + L0_BCC_Al_V/G_normalize - L0_BCC_Al_Ti/G_normalize - L0_BCC_Ti_V/G_normalize + 
								(1-2*c_Al-2*c_V)*L0_BCC_Al_Ti_V/G_normalize) + gradient[0][21]*(-gradient[0][21]/pow(c_V,2) + (gradient[0][20] + 
								gradient[0][21])/pow((1-c_Al-c_V),2) - 2*gradient[0][20]*L0_BCC_Al_Ti_V/G_normalize) + gradient[0][20]*((gradient[0][20] + 
								gradient[0][21])/pow((1-c_Al-c_V),2) + (-2*gradient[0][20]*gradient[0][21])*L0_BCC_Al_Ti_V/G_normalize) ;
}
